...
export function renderWizardHtml(options: {
  ...
  const apkCard = options.apkUrl && options.apkQrSvg ? `
    <section class="apk" data-stage="apk">
      <div><div class="num">STEP 01 / DOWNLOAD</div><h2>下载 Community APK</h2><p>使用安卓手机扫描二维码下载安装，安装完成后返回本页继续配置连接。</p><div class="actions"><a class="button" href="${escapeHtml(options.apkUrl)}" target="_blank" rel="noreferrer">下载 APK</a></div></div>
